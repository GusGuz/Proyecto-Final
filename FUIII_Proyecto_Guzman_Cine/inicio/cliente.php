                    ...
                    <div class="row"> 
                        <div class="col-md-3">
                            ...
                            <form action="insertarc.php" method="POST">
                                    ...
                                    Fecha de Nacimiento<input type="date" class="form-control mb-3" name="fecha_nacimiento" step="1" min="1910-01-01" max="2021-12-01" value="<?php echo date("Y-m-d");?>">
                                ...
                                <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <th><a href="actualizarc.php?id=<?php echo $row['id'] ?>" class="btn btn-info">Editar</a></th>
                                                <th><a href="deletec.php?id=<?php echo $row['id'] ?>" class="btn btn-danger">Eliminar</a></th>                                        
                                            </tr>
                                        <?php 
                                            }
                                        ?>
